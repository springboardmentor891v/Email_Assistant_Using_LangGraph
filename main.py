from src.tools import fetch_recent_emails, extract_body, extract_email_parts, format_email_for_llm, query_gmail_assistant, ask_gmail, search_gmail
...
if __name__ == "__main__":
    ...
    for msg in messages:
        ...
        if decision == "IGNORE":
            ...
            create_draft_reply(gmail_service, calendar_service, sender, subject, body)
