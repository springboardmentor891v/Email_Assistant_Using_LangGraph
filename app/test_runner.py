"""
Test runner for Email Assistant
Captures output to a file for easy review
"""
...
def main():
    ...
    with open('test_output.txt', 'w', encoding='utf-8') as f:
        ...
        try:
            ...
            for i, email in enumerate(test_emails, 1):
                ...
                try:
                    ...
                    if result.get('react_result'):
                        ...
                        if result['react_result']['actions_taken']:
                            print(f"\n  Actions Details:")
                            for action in result['react_result']['actions_taken']:
                                print(f"    {action['iteration']}. {action['tool']} -> {action['result'][:100]}...")
            ...
            print("3. Set LANGCHAIN_TRACING_V2=true in .env")
            print("4. Re-run this script to see traces in LangSmith dashboard")
            print("="*70 + "\n")
